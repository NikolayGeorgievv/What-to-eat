...
public enum Prompts {
    ;
    public static final String PROMPT_FOR_INGREDIENTS_INPUT = "You are a professional chef. Generate only ONE recipe based ONLY on the provided ingredients. " +
    ...
    public static final String PROMPT_FOR_RECIPE_NAME_INPUT = "You are a professional chef. Generate only ONE recipe based ONLY on the provided recipe name. " +
            "                                        Start immediately with the recipe name, followed by ' ...', then the full recipe. " +
            "                                        The recipe name should stand out by using `## Recipe Name " +
            "                                        The recipe should include ingredients and step-by-step instructions. " +
            "                                        Do NOT add any extra text like greetings or explanations. " +
    ...
    public static final String PROMPT_FOR_GENERATE_ANOTHER_RECIPE = "You are a professional chef. Generate only ONE recipe based ONLY on the provided ingredients. " +
